...
## 🔓 Bước 1: Bật chế độ Nhà phát triển trên iPhone (Chỉ dành cho iOS 16 trở lên)

Anh/chị cần bật chế độ này trước khi tiến hành cài đặt ứng dụng.
...
## 🚀 Các bước cài đặt bằng Sideloadly (Dễ nhất trên Windows)
...
## ✅ Bước 5: Tin cậy Chứng chỉ Ứng dụng

Sau khi cài đặt xong, anh/chị chưa thể mở app ngay lập tức. Apple yêu cầu anh/chị phải "Tin cậy" nhà phát triển.
...
## ⚠️ Lưu ý quan trọng
- **Gia hạn chứng chỉ:** Vì dùng tài khoản Apple ID miễn phí, ứng dụng sẽ bị **hết hạn sau 7 ngày**. Sau 7 ngày, app sẽ bị văng khi mở. Anh/chị KHÔNG cần xóa app, chỉ cần cắm cáp vào máy tính, mở Sideloadly và làm lại Bước 4 (dữ liệu sổ tay vẫn sẽ được giữ nguyên).
